    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-violet-950 via-background to-indigo-950 p-4">
      ...
      <Card className="relative w-full max-w-md border-border/40 bg-card/80 backdrop-blur-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start managing your church finances</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" className="font-medium text-violet-600 hover:text-violet-500 dark:text-violet-400">Sign in</Link>
          </p>
        </CardContent>
      </Card>
    </div>
